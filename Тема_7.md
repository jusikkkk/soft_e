...
## Выводы
Добавлене трат в книгу расходоа происходит в цикле `for i in range(1, i+1)`, где i - количество расходов. Если i = 0, то в консоль будут выведены все существующие расходы без добавления новых.
